...
public class XmlRpcValue : IEquatable<XmlRpcValue>, IComparable<XmlRpcValue>
{
    ...
    /// </summary>
    public static XmlRpcValue Nil { get; } = new(null, XmlRpcType.Nil);
    ...
    public static XmlRpcValue FromInt(int value)
    {
        return new XmlRpcValue(value, XmlRpcType.Integer);
    }
    ...
    public static XmlRpcValue FromLong(long value)
    {
        return new XmlRpcValue(value, XmlRpcType.Long);
    }
    ...
    public static XmlRpcValue FromBoolean(bool value)
    {
        return new XmlRpcValue(value, XmlRpcType.Boolean);
    }
    ...
    public static XmlRpcValue FromString(string value)
    {
        return new XmlRpcValue(value ?? string.Empty, XmlRpcType.String);
    }
    ...
    public static XmlRpcValue FromDouble(double value)
    {
        return new XmlRpcValue(value, XmlRpcType.Double);
    }
    ...
    public static XmlRpcValue FromDateTime(DateTime value)
    {
        return new XmlRpcValue(value, XmlRpcType.DateTime);
    }
    ...
    /// <returns>A new XmlRpcValue representing the DateTime.</returns>
    public static XmlRpcValue FromDateTime(DateTimeOffset value)
    {
        return new XmlRpcValue(value.DateTime, XmlRpcType.DateTime);
    }
    ...
    public static XmlRpcValue FromBase64(byte[] value)
    {
        return new XmlRpcValue(value, XmlRpcType.Base64);
    }
    ...
    public static XmlRpcValue FromStruct(Dictionary<string, XmlRpcValue> value)
    {
        return new XmlRpcValue(value, XmlRpcType.Struct);
    }
    ...
    public static XmlRpcValue FromArray(XmlRpcValue[] value)
    {
        return new XmlRpcValue(value, XmlRpcType.Array);
    }
    ...
    /// <returns>A new XmlRpcValue representing the array.</returns>
    public static XmlRpcValue FromArray(IEnumerable<XmlRpcValue> value)
    {
        return new XmlRpcValue(value.ToArray(), XmlRpcType.Array);
    }
    ...
    public static XmlRpcValue FromObject(object? value)
    {
        return value switch
        {
            null => Nil,
            ...
            IDictionary<string, object> objDict => FromStruct(objDict.ToDictionary(kvp => kvp.Key,
                kvp => FromObject(kvp.Value))),
            ...
            _ => throw new ArgumentException($"Unsupported type for XML-RPC conversion: {value.GetType().FullName}",
                nameof(value))
        };
    }
    ...
    public int AsInteger => Type switch
    {
        XmlRpcType.Integer => (int)RawValue!,
        XmlRpcType.Long => Convert.ToInt32((long)RawValue!),
        XmlRpcType.Double => Convert.ToInt32((double)RawValue!),
        XmlRpcType.Boolean => (bool)RawValue! ? 1 : 0,
        XmlRpcType.String => int.Parse((string)RawValue!),
    ...
    {
        XmlRpcType.Integer => (int)RawValue!,
        XmlRpcType.Long => (long)RawValue!,
        XmlRpcType.Double => Convert.ToInt64((double)RawValue!),
        XmlRpcType.Boolean => (bool)RawValue! ? 1 : 0,
        XmlRpcType.String => long.Parse((string)RawValue!),
    ...
    {
        XmlRpcType.Boolean => (bool)RawValue!,
        XmlRpcType.Integer => (int)RawValue! != 0,
        XmlRpcType.Long => (long)RawValue! != 0,
        XmlRpcType.Double => (double)RawValue! != 0,
        XmlRpcType.String => bool.Parse((string)RawValue!),
    ...
    {
        XmlRpcType.String => (string)RawValue!,
        XmlRpcType.Integer => ((int)RawValue!).ToString(),
        XmlRpcType.Long => ((long)RawValue!).ToString(),
        XmlRpcType.Double => ((double)RawValue!).ToString("G17"),
        XmlRpcType.Boolean => (bool)RawValue! ? "true" : "false",
        XmlRpcType.DateTime => ((DateTime)RawValue!).ToString("o"),
        XmlRpcType.Base64 => Convert.ToBase64String((byte[])RawValue!),
    ...
    {
        XmlRpcType.Double => (double)RawValue!,
        XmlRpcType.Integer => (int)RawValue!,
        XmlRpcType.Long => (long)RawValue!,
        XmlRpcType.Boolean => (bool)RawValue! ? 1.0 : 0.0,
        XmlRpcType.String => double.Parse((string)RawValue!),
    ...
    {
        XmlRpcType.DateTime => (DateTime)RawValue!,
        XmlRpcType.String => DateTime.Parse((string)RawValue!),
    ...
    public byte[] AsBase64 => Type switch
    {
        XmlRpcType.Base64 => (byte[])RawValue!,
        XmlRpcType.String => Convert.FromBase64String((string)RawValue!),
        _ => throw new InvalidOperationException($"Cannot convert {Type} to byte array")
    };
    ...
    public Dictionary<string, XmlRpcValue> AsStruct => Type == XmlRpcType.Struct
        ? (Dictionary<string, XmlRpcValue>)RawValue!
        : throw new InvalidOperationException($"Cannot convert {Type} to struct");

    /// <summary>
    ///     Gets the value as an array.
    /// </summary>
    /// <exception cref="InvalidOperationException">Thrown if the value is not an array.</exception>
    public XmlRpcValue[] AsArray => Type == XmlRpcType.Array
        ? (XmlRpcValue[])RawValue!
        : throw new InvalidOperationException($"Cannot convert {Type} to array");

    /// <summary>
    ///     Gets a value indicating whether this value is nil.
    /// </summary>
    public bool IsNil => Type == XmlRpcType.Nil;
    ...
    /// </summary>
    public static implicit operator XmlRpcValue(long value)
    {
    ...
    /// </summary>
    public static implicit operator XmlRpcValue(DateTime value)
    {
    ...
    /// </summary>
    public static implicit operator XmlRpcValue(byte[] value)
    {
    ...
    /// </summary>
    public static explicit operator long(XmlRpcValue value)
    {
        return value.AsLong;
    }
    ...
    public bool Equals(XmlRpcValue? other)
    {
        ...
        {
            XmlRpcType.Nil => true,
            XmlRpcType.Integer => (int)RawValue! == (int)other.RawValue!,
            XmlRpcType.Long => (long)RawValue! == (long)other.RawValue!,
            XmlRpcType.Boolean => (bool)RawValue! == (bool)other.RawValue!,
            XmlRpcType.String => (string)RawValue! == (string)other.RawValue!,
            XmlRpcType.Double => Math.Abs((double)RawValue! - (double)other.RawValue!) < double.Epsilon,
            XmlRpcType.DateTime => (DateTime)RawValue! == (DateTime)other.RawValue!,
            XmlRpcType.Base64 => ((byte[])RawValue!).SequenceEqual((byte[])other.RawValue!),
            XmlRpcType.Struct => StructEquals((Dictionary<string, XmlRpcValue>)RawValue!,
                (Dictionary<string, XmlRpcValue>)other.RawValue!),
            XmlRpcType.Array => ((XmlRpcValue[])RawValue!).SequenceEqual((XmlRpcValue[])other.RawValue!),
            _ => false
        };
    }
    ...
    {
        return Equals(obj as XmlRpcValue);
    }
    ...
    public int CompareTo(XmlRpcValue? other)
    {
        ...
        {
            XmlRpcType.Nil => 0,
            XmlRpcType.Integer => ((int)RawValue!).CompareTo((int)other.RawValue!),
            XmlRpcType.Long => ((long)RawValue!).CompareTo((long)other.RawValue!),
            XmlRpcType.Boolean => ((bool)RawValue!).CompareTo((bool)other.RawValue!),
            XmlRpcType.String => string.Compare((string)RawValue!, (string)other.RawValue!, StringComparison.Ordinal),
            XmlRpcType.Double => ((double)RawValue!).CompareTo((double)other.RawValue!),
            XmlRpcType.DateTime => ((DateTime)RawValue!).CompareTo((DateTime)other.RawValue!),
            XmlRpcType.Base64 => CompareByteArrays((byte[])RawValue!, (byte[])other.RawValue!),
            XmlRpcType.Struct => ((Dictionary<string, XmlRpcValue>)RawValue!).Count.CompareTo(
                ((Dictionary<string, XmlRpcValue>)other.RawValue!).Count),
            XmlRpcType.Array => ((XmlRpcValue[])RawValue!).Length.CompareTo(((XmlRpcValue[])other.RawValue!).Length),
            _ => 0
        };
    }
    ...
    {
        return (T?)ToObject(typeof(T), converters);
    }
    ...
    public object? ToObject(Type targetType, IReadOnlyList<XmlRpcConverter>? converters = null)
    {
        ...
        if (Type == XmlRpcType.Nil)
            return underlyingType.IsValueType ? null : null;

        // Handle enums — XAPI returns enum values as lowercase/snake_case strings
        if (underlyingType.IsEnum)
        {
            ...
            // Try converting snake_case to PascalCase: "some_value" → "SomeValue"
            var pascalCase = string.Join("",
                str.Split('_').Select(s => s.Length > 0 ? char.ToUpper(s[0]) + s[1..] : ""));
            return Enum.Parse(underlyingType, pascalCase, ignoreCase: true);
        }
        ...
        if (underlyingType.IsGenericType && underlyingType.GetGenericTypeDefinition() == typeof(Dictionary<,>))
        {
            ...
            foreach (var kvp in AsStruct)
                dict[kvp.Key] = kvp.Value.ToObject(valueType, converters)!;
            return dict;
        }
        ...
        if (underlyingType.IsGenericType && underlyingType.GetGenericTypeDefinition() == typeof(List<>))
        {
            ...
            foreach (var item in sourceArray) list.Add(item.ToObject(elementType, converters));
            return list;
        }

        // Handle complex objects via struct
        if (Type == XmlRpcType.Struct) return ConvertStructToObject(underlyingType, converters);

        throw new InvalidOperationException($"Cannot convert {Type} to {targetType.FullName}");
    }
    ...
    private object? ConvertStructToObject(Type targetType, IReadOnlyList<XmlRpcConverter>? converters = null)
    {
        ...
        foreach (var prop in properties)
        {
            ...
            var name = prop.Name;
            var attr =
                prop.GetCustomAttributes(typeof(XmlRpcMemberAttribute), false)
                    .FirstOrDefault() as XmlRpcMemberAttribute;
            if (attr != null && !string.IsNullOrEmpty(attr.Name)) name = attr.Name;
    ...
    public override void Write(Utf8JsonWriter writer, XmlRpcValue value, JsonSerializerOptions options)
    {
        switch (value.Type)
        {
            ...
            case XmlRpcType.Array:
                ...
                foreach (var item in value.AsArray) Write(writer, item, options);
